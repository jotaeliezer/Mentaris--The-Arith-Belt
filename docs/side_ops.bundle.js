...
(() => {
  ...
  function renderField(field, values, onChange) {
    ...
    const wrap = el2("div", { class: "sideOpsField" });
    wrap.appendChild(el2("label", { for: id }, [field.label]));
    ...
    if (field.hint)
      wrap.appendChild(el2("div", { class: "hint" }, [field.hint]));
    return wrap;
  }
  ...
  function showPlay(game, config) {
    ...
    const wrap = el2("div", { style: "position:relative;" }, [
      hudBar,
      gameContainer,
      pauseOverlay,
      resultsOverlay
