...
export function createState(){
  return {
    ...
    flaresRadius:150,
    flaresStrength:480,
    frontclearFxActive:false,
    frontclearFxTimer:0,
    frontclearFxDur:0.22,
    frontclearFxX:0,
    frontclearFxY:0,
    downshockFxActive:false,
    downshockFxTimer:0,
    downshockFxDur:0.35,
    downshockFxOriginX:0,
    downshockFxOriginY:0,
    downshockFxRays:[],
    knock3FxActive:false,
    knock3FxTimer:0,
    knock3FxDur:0.22,
    knock3FxBursts:[],
    answerDigits:[],
